    ...
    <Card title="Education">
      <div className="relative border-l-4 border-red-500">
        <div className="mb-5 ml-4">
          <div className="absolute -left-2 mt-1.5 h-3 w-3 rounded-full border border-white bg-yellow-500"></div>
        ...
        <div className="mb-5 ml-4">
          ...
          <div className="rounded-lg bg-white p-2 shadow-md">
            ...
            <h2 className="mb-2 text-sm font-semibold">Darussalam School</h2>
          </div>
        </div>
      </div>
    </Card>
